...
import com.dzyuba.javaboost.presentation.ide.common.utils.Flag;
...
import com.dzyuba.javaboost.presentation.ide.common.utils.StringUtils;
...
public class AutoCompletePanel {
    ...
    public class AutoPanelAdapter extends BaseAdapter implements Filterable {
        ...
        AutoPanelAdapter(Context context) {
            abort = new Flag();
            bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_function);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View tempView;
            if (view == null) {
                tempView = LayoutInflater.from(context).inflate(R.layout.item_auto_code, null);
            } else {
                tempView = view;
            }
