...
public class YoyoNavigationMethod extends TouchNavigationMethod {
    ...
    public YoyoNavigationMethod(FreeScrollingTextField textField) {
        ...
        yoyoSize = (int) TypedValue.applyDimension(2, (float) (FreeScrollingTextField.BASE_TEXT_SIZE_PIXELS * 1.5), dm);
        yoyoCaret = new Yoyo();
        yoyoStart = new Yoyo();
        yoyoEnd = new Yoyo();
    }
    ...
    public void onColorSchemeChanged(ColorScheme colorScheme) {
        ...
        yoyoCaret.setHandleColor(colorScheme.getColor(ColorScheme.ColorType.CARET_BACKGROUND));
    }

    private class Yoyo {
        private final int YOYO_STRING_RESTING_HEIGHT = yoyoSize / 3;
        private final Rect HANDLE_RECT = new Rect(0, 0, yoyoSize, yoyoSize);
        ...
        public Yoyo() {
            ...
            _brush = new Paint();
            _brush.setColor(scrollingTextField.getColorScheme().getColor(ColorScheme.ColorType.CARET_BACKGROUND));
