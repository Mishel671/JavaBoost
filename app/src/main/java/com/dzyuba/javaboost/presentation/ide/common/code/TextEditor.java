...
import com.dzyuba.javaboost.presentation.ide.common.utils.ColorSchemeDark;
...
import com.dzyuba.javaboost.presentation.ide.common.utils.LanguageJava;
...
public class TextEditor extends FreeScrollingTextField {
    ...
    public void loadAppInfoJavaFile() {
        String infoJavaFile = PathUtils.getExternalAppCachePath() + "/Main.java";
        ResourceUtils.copyFileFromAssets("Main.java", infoJavaFile);
        open(infoJavaFile);
        System.out.println("");
    }
}
